...
def generate_internal_monologue(base64_image):
    ...
    try:
        prompt = "You're my internal monologue. What do you think looking at this? (respond in the way that will help the creater of this device the most, inspired by the selfish gene by Richard Dawkins)"
